            ...
            <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
                ...
                <div className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                    ...
                    <div className="relative mb-4">
                        <label htmlhtmlFor="full-name" className="leading-7 text-sm text-gray-600">Email</label>
                    ...
                    <div className="relative mb-4">
                        <label htmlhtmlFor="email" className="leading-7 text-sm text-gray-600">Password</label>
                        <input type="password" id="email" name="email" className="w-full bg-white rounded border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                    </div>
